                ...
                child: Column(
                  children: [
                    ...
                    model.isBusy
                        ...
                        :  Column(
                      children:model.semesters.semesters.entries.expand((entry) {
                        final semNumber = entry.key.replaceAll(RegExp(r'\D'), '');
                          ...
                          AnimatedContainer(
                            ...
                            child: ExpansionTile(
                              tilePadding: EdgeInsets.symmetric(
                                  horizontal: SizeConfig.screenHeight! * 0.02, vertical: 0),
                              ...
                              children: subjects.subjects.entries.map((subjectEntry) {
